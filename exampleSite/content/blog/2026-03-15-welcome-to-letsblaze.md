...
Collapsible navigation? `<details>` and `<summary>`. Skip links? Pure CSS. Dark mode? `prefers-color-scheme` media query. Syntax highlighting? Chroma at build time, baked into the HTML.
